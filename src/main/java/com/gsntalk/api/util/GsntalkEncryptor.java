...
public class GsntalkEncryptor {

	private static SecretKeySpec keySpec;
	
	// AES Key, only 16 byte size.
	private static final String AES_128_KEY = "(_^_gsn-talk_^_)";
	
	// SHA Encrypt add salt ( you can customizing )
	private static final String[] SALT = { "5", ":", "c", "6", ".", "*", "[", "!", "-", "0", "^", "#", "a", "R", "=", "v", ")", "?" };
	...
	public static String encrypt( String plainText ) throws Exception {
		if( GsntalkUtil.isEmpty( plainText ) ) {
			return "";
		}
	...
	public static String decrypt( String encryptedText )throws Exception {
		if( GsntalkUtil.isEmpty( encryptedText ) ) {
			return "";
		}
	...
	public static String sha512( String message ) throws Exception {
		if( GsntalkUtil.isEmpty( message ) ) {
			return "";
		}
